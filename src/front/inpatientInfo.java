 ...
 * @author asus
 */
public class inpatientInfo extends javax.swing.JFrame {
    ...
    public void tableload()
    {
        try {
            ...
            String query = "SELECT * FROM inpatient_info";
            ...
            try {
                st = con.createStatement();
            String query = "SELECT `patient_id`, `Name`, `Birth_Date`, `Admit_Date`, `Admit_Time`, `Discharge_Date`, `Discharge_Time`, `PrimaryDoctor_No`, `WardNo`, `BedNo` FROM inpatient_info";
            ResultSet rs =  st.executeQuery(query);
            jTable1.setModel(DbUtils.resultSetToTableModel(rs));
                ...
                try {
                    st = con.createStatement();
            String query = "SELECT `patient_id`, `Name`, `Birth_Date`, `Admit_Date`, `Admit_Time`, `Discharge_Date`, `Discharge_Time`, `WardNo`, `BedNo` FROM inpatient_info";
            ResultSet rs =  st.executeQuery(query);
            jTable1.setModel(DbUtils.resultSetToTableModel(rs));
                } catch (Exception exx) {
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(inpatientInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new inpatientInfo().setVisible(true);
            }
        });
    }
