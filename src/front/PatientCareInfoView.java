 ...
 * @author asus
 */
public class PatientCareInfoView extends javax.swing.JFrame {
    ...
    public void tableload()
    {
        try {
            ...
            String query = "SELECT * FROM patientcare";
            ...
            try {
                st = con.createStatement();
            String query = "SELECT `PatientCareUnit_No`, `PCType`, `Ward_Name`,  `WardNo`, `Diag_No`, `Diagnostic_Name` FROM patientcare";
            ResultSet rs =  st.executeQuery(query);
            jTable1.setModel(DbUtils.resultSetToTableModel(rs));
            } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientCareInfoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PatientCareInfoView().setVisible(true);
            }
        });
    }
