 ...
 * @author asus
 */
public class OutpatientInfo extends javax.swing.JFrame {
    ...
    public void tableload()
    {
        try {
            ...
            String query = "SELECT * FROM outpatient_info";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OutpatientInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OutpatientInfo().setVisible(true);
            }
        });
    }
