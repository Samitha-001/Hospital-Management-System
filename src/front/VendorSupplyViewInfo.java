 ...
 * @author asus
 */
public class VendorSupplyViewInfo extends javax.swing.JFrame {
    ...
    public void tableload()
    {
        try {
            ...
            String query = "SELECT * FROM vendor_supply";
            ResultSet rs =  st.executeQuery(query);
            jTable1.setModel(DbUtils.resultSetToTableModel(rs));
            
            
        }catch(java.sql.SQLSyntaxErrorException ee){
            JOptionPane.showMessageDialog(null, "Insufficient Permission");
        } 
        catch (Exception e) {
        }
    } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VendorSupplyViewInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VendorSupplyViewInfo().setVisible(true);
            }
        });
    }
