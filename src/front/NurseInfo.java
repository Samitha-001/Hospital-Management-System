 ...
 * @author asus
 */
public class NurseInfo extends javax.swing.JFrame {
    ...
    public void tableload()
    {
        try {
            ...
            String query = "SELECT * FROM nurse_info";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NurseInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
